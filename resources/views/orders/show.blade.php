                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th class="item-amount text-right">小计</th>
                            </tr>
                        </thead>
                        @foreach ($order->items as $index => $item)
                            <tr>
                                ...
                                <td class="sku-price vertical-middle text-center">￥{{ $item->price }}</td>
                                <td class="sku-amount vertical-middle text-center">{{ $item->amount }}</td>
                                <td class="item-amount vertical-middle text-right">
