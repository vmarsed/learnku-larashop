...
return [
    'alipay' => [
        'default' => [
            ...
            'app_public_cert_path' => base_path('safe/alipay-sandbox/appPublicCert.crt'),
            // 必填-支付宝公钥证书 路径
            'alipay_public_cert_path' => base_path('safe/alipay-sandbox/alipayPublicCert.crt'),
            // 必填-支付宝根证书 路径
            'alipay_root_cert_path' => base_path('safe/alipay-sandbox/alipayRootCert.crt'),
